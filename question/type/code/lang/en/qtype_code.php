...
/**
 * Strings for component 'qtype_code', language 'en', branch 'MOODLE_20_STABLE'
 *
 * @package    qtype
 * @subpackage code
...
$string['pluginname_help'] = 'This question type creates a formatted input box where students can enter code. Supports automatic grading.';
$string['pluginname_link'] = 'question/type/code';
$string['pluginnameadding'] = 'Adding a code question';
$string['pluginnameediting'] = 'Editing a code question';
